...
public class Robot {
  ...
  void drawBody(float timer, int x, int y, int z) {
    ...
    // Breast.
    fillColor.setColor("robC3");
    pushMatrix();
    translate(0 + x, 100 + y, 0 + z);
    scale(120, 80, 120);
    solidFigure.drawPillar(1.3, 1, 1);
    popMatrix();

    // Right screw.
    fillColor.setColor("robC4");
    pushMatrix();
  ...
  void drawHand(float timer, int x, int y, int z, int control) {
    ...
    // Forearm 4.
    fillColor.setColor("robC7");
    pushMatrix();
    translate((control*147) + x, 180 + y, 0 + z);
    scale(90, 8, 90);
    solidFigure.drawPillar(10, 0.1, 0.1);
    popMatrix();
    ...
    // Finger 1-1.
    fillColor.setColor("robC9");
    pushMatrix();
    translate((control*147) + x, 270 + y, 8 + z);
    scale(40, 40, 40);
    solidFigure.drawPillar(1, 0.1, 0.1);
    popMatrix();

    // Finger 1-2.
    fillColor.setColor("robC10");
    pushMatrix();
